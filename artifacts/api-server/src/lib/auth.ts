...
/**
 * Single-shared-password admin auth. Cookie `admin-auth` holds a signed token
 * `<issuedAtMs>.<hmacHex>`; the HMAC is verified on every request.
 */
...
/** Express cookie options (maxAge in ms). */
