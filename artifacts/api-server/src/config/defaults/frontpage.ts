...
/**
 * Bundled default content for the public front page (/). Seeded into the
 * `site_content` table on bootstrap and used as the fallback whenever the DB is
 * unavailable — mirrors how the client/talent defaults back their pages. This is
 * the copy the front page shipped with before it became admin-editable.
 */
